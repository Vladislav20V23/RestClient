...
public class Communication {
    ...
    private final String URL = "http://localhost:8081/Notes/api/employees";
    ...
    public void saveEmployee(Employee employee){
        ...
        if(id == 0) {
            ...
            System.out.println("В Базу добавлен новый работник: ");
            System.out.println(responseEntity.getBody());
        } else {
            restTemplate.put(URL, employee);
            System.out.println("Работник с id = " + id + " был изменен");
        }
